========================================================================
    ACTIVE TEMPLATE LIBRARY : PingAtlServer Project Overview
========================================================================

AppWizard has created this PingAtlServer project for you to use as the starting point for
writing your Executable (EXE).

This file contains a summary of what you will find in each of the files that
make up your project.

PingAtlServer.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

PingAtlServer.vcxproj.filters
...
PingAtlServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (PingAtlServer.h)
        GUID definitions                                (PingAtlServer_i.c)
        A type library                                  (PingAtlServer.tlb)
        Marshaling code                                 (PingAtlServer_p.c and dlldata.c)

PingAtlServer.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in PingAtlServer.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named PingAtlServer.pch and a precompiled types file named StdAfx.obj.
...
PingAtlServerps.vcxproj
	...
	dlldata.c, PingAtlServer_i.c and PingAtlServer_p.c which are required
	to build the proxy/stub DLL.

PingAtlServerps.vcxproj.filters
